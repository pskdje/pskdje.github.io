...
const calendar = {
	 ...
	 * 阳历节日
	 */
	// 联合国国际日和国际周列表: https://www.un.org/zh/observances/list-days-weeks
	festival: {
		'1-1': {title: '元旦节'},
		"1-4": {title: "世界盲文日"},
		"1-10": {title: "中国人民警察节"},
		...
		'3-12': {title: '植树节'},
		"3-20": {title: "国际幸福日"},
		"3-21": {title: "国际森林日 世界冰川日"},
		"3-22": {title: "世界水日"},
		"3-23": {title: "世界气象日"},
		"3-24": {title: "世界防治结核病日"},
		"3-30": {title: "国际零废物日"},
		'4-1': {title: '愚人节'},
		"4-2": {title: "世界提高自闭症意识日"},
		"4-4": {title: "国际提高地雷意识和协助地雷行动日"},
		"4-5": {title: "国际良心日"},
		"4-6": {title: "体育促进发展与和平国际日"},
		"4-7": {title: "世界卫生日"},
		"4-12": {title: "载人空间飞行国际日"},
		"4-21": {title: "世界创意和创新日"},
		"4-22": {title: "世界地球日"},
		"4-23": {title: "世界读书日"},
		"4-28": {title: "世界工作安全与健康日"},
		'5-1': {title: '劳动节'},
		'5-4': {title: '青年节'},
		'5-12': {title: '护士节'},
		"5-15": {title: "国际家庭日"},
		"5-16": {title: "国际和平共处日"},
		"5-17": {title: "世界电信和信息社会日"},
		"5-22": {title: "生物多样性国际日"},
		"5-25": {title: "世界足球日"},
		"5-29": {title: "联合国维持和平人员国际日"},
		"5-31": {title: "世界无烟日"},
		'6-1': {title: '儿童节'},
		"6-3": {title: "世界自行车日"},
		"6-5": {title: "世界环境日"},
		...
		"6-13": {title: "国际白化病宣传日"},
		"6-14": {title: "世界献血者日"},
		"6-17": {title: "防治荒漠化和干旱世界日"},
		"6-18": {title: "打击仇恨言论国际日"},
		"6-26": {title: "禁止药物滥用和非法贩运国际日"},
		"6-29": {title: "国际热带日"},
		"6-30": {title: "国际小行星日"},
		'7-1': {title: '建党节'},
		"7-11": {title: "世界人口日"},
		...
		"10-27": {title: "世界音像遗产日"},
		"10-31": {title: "世界城市日"},
		"11-2": {title: "终止针对记者犯罪不受惩罚现象国际日"},
		"11-5": {title: "世界海啸意识日"},
		"11-6": {title: "防止战争和武装冲突糟蹋环境国际日"},
		"11-10": {title: "争取和平与发展世界科学日"},
		"11-14": {title: "世界糖尿病日"},
		"11-15": {title: "预防和打击一切形式跨国有组织犯罪国际日"},
		"11-16": {title: "国际宽容日"},
		"11-19": {title: "世界厕所日"},
		"11-20": {title: "世界儿童日"},
		"11-21": {title: "世界电视日"},
		"11-26": {title: "世界可持续交通运输日"},
		"12-1": {title: "世界艾滋病日"},
		"12-3": {title: "国际残疾人日"},
		"12-4": {title: "国际银行日"},
		"12-5": {title: "世界土壤日 国际志愿人员日"},
		"12-7": {title: "国际民航日"},
		"12-9": {title: "缅怀灭绝种族罪受害者、受害者尊严和防止此种罪行国际日"},
		"12-10": {title: "人权日"},
		"12-11": {title: "国际山岳日"},
		"12-12": {title: "国际全民健康覆盖日"},
		"12-13": {title: "国家公祭日"},
		"12-20": {title: "国际人类团结日"},
		"12-21": {title: "世界篮球日 世界冥想日"},
		'12-24': {title: '平安夜'},
		'12-25': {title: '圣诞节'},
		"12-27": {title: "防范流行病国际日"},
	},
	 ...
	 */
	// 2024-12-13将弃用的substr改成有效的slice
